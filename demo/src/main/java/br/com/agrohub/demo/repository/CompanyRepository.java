...
public interface CompanyRepository extends JpaRepository<Company, Long> {
    ...
    // Busca empresa pela Razão Social (útil para pesquisa administrativa ou display)
    Optional<Company> findByRazaoSocial(String razaoSocial);
    
    // Buscar empresa pelo ID do User associado (útil após o login para carregar o perfil)
